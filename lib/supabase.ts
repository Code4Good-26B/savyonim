...
function getSupabaseUrl() {
  ...
  if (!supabaseUrl) {
    throw new Error("Missing required Supabase environment variable: NEXT_PUBLIC_SUPABASE_URL or SUPABASE_URL");
  }
...
function getSupabaseAnonKey() {
  ...
  if (!anonKey) {
    throw new Error("Missing required Supabase environment variable: NEXT_PUBLIC_SUPABASE_ANON_KEY or SUPABASE_ANON_KEY");
  }
