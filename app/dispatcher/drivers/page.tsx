...
export default async function DriversPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-semibold text-gray-900">נהגים</h1>
      ...
      <div className="grid grid-cols-4 gap-4">
        {[
          ...
          <div key={stat.label} className={`${card} border-t-4 ${stat.accent} gap-3`}>
              ...
              drivers.map((driver) => {
                ...
                return (
                  <tr key={driver.id} className="hover:bg-blue-50/30 transition-colors">
                    ...
                    <td className="px-6 py-4 text-gray-500 tabular-nums">{driver.contact_phone ?? "—"}</td>
