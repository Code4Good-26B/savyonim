...
export default async function AdminRepresentativesPage() {
  ...
  return (
    <div className="flex flex-col gap-6" dir="rtl">
      <div>
        <h1 className="text-xl font-semibold text-gray-900">נציגים</h1>
        <p className="mt-1 text-sm text-gray-400">כלל הנציגים הרשומים במערכת</p>
      </div>
      ...
      <div className="grid grid-cols-4 gap-4">
        {[
          ...
          },
          {
            ...
            icon: <svg className="w-5 h-5 text-gray-300" fill="none" stroke="currentColor" strokeWidth={1.6} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>,
          },
          {
